class ScreenMedia {
  ...
  static ScreenMediaType getScreenMediaType(double width) {
    ...
    else if (width < _ScreenMediaBreakPoint.XXXXL) return ScreenMediaType.XXXL;
  ...
  static bool isMinimumSize(ScreenMediaType screenMediaType,
      {double? currentWidth, ScreenMediaType? currentScreenMediaType}) {
    double width = currentWidth ??
        getSizeFromScreenMediaType(currentScreenMediaType).toDouble();
...
enum ScreenMediaType { XS, SM, MD, LG, XL, XXL, XXXL, XXXXL }
